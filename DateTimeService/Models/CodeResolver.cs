...
namespace DateTimeService.Models
{
    ...
    public class AvailableDeliveryTypesCodeResolver : IValueResolver<RequestAvailableDeliveryTypesItemDTO, RequestAvailableDeliveryTypesItem, string>
    {
        public string Resolve(RequestAvailableDeliveryTypesItemDTO source, RequestAvailableDeliveryTypesItem destination, String destMember, ResolutionContext context)
        {
            if (source.SalesCode == null)
                return null;
            else
