...
GROUP BY
	...
	T5.ВремяОкончания,
	PlanningGroups.Приоритет
OPTION (HASH GROUP, OPTIMIZE FOR (@P_DateTimePeriodBegin='4022-06-15T00:00:00',@P_DateTimePeriodEnd='4022-06-22T00:00:00'),KEEP PLAN, KEEPFIXED PLAN);
...
Group By 
	...
	#Temp_IntervalsAll.Геозона,
    #Temp_IntervalsAll.Приоритет
OPTION (OPTIMIZE FOR (@P_DateTimePeriodBegin='4022-06-15T00:00:00',@P_DateTimePeriodEnd='4022-06-22T00:00:00'), KEEP PLAN, KEEPFIXED PLAN);
