...
('6270100',NULL,NULL,0),
('6240333',NULL,NULL,0),
('936160',NULL,'340,388,460,417,234,2',0),
('6538254',NULL,'340,388,460,417,234,2',0),
('6445654',NULL,'340,388,460,417,234,2',0),
('390364',NULL,'340,388,460,417,234,2',0),
('6832025',NULL,'340,388,460,417,234,2',0),
('6155002',NULL,'340,388,460,417,234,2',0),
('1102868',NULL,'340,388,460,417,234,2',0),
('5689276',NULL,'340,388,460,417,234,2',0),
('6454040',NULL,'340,388,460,417,234,2',0),
('6548698',NULL,'340,388,460,417,234,2',0),
('802362',NULL,'340,388,460,417,234,2',0),
('6538250',NULL,'340,388,460,417,234,2',0),
('6240254',NULL,'340,388,460,417,234,2',0),
('6743345',NULL,'340,388,460,417,234,2',0),
('6141567',NULL,'340,388,460,417,234,2',0),
('6743336',NULL,'340,388,460,417,234,2',0),
('6274388',NULL,'340,388,460,417,234,2',0),
('6297895',NULL,'340,388,460,417,234,2',0),
('6523024',NULL,'340,388,460,417,234,2',0),
('6548703',NULL,'340,388,460,417,234,2',0),
('6252550',NULL,'340,388,460,417,234,2',0),
('6297906',NULL,'340,388,460,417,234,2',0),
('5733338',NULL,'340,388,460,417,234,2',0),
('6790095',NULL,'340,388,460,417,234,2',0)
...
SELECT
	...
	T1.code,
    T1.СкладНазначения,
    Case when ПрослеживаемыеТНВЭД._Fld27184RRef is null then T1.БлижайшаяДата else DateAdd(DAY, 100, ПрослеживаемыеТНВЭД._Period) end as БлижайшаяДата,
    T1.Количество,
    T1.Вес,
    T1.Объем,
    T1.ВремяНаОбслуживание,
...
FROM
	...
	left join dbo._InfoRg27183 as ПрослеживаемыеТНВЭД WITH(NOLOCK)
		on 1 = 1 -- это будет значение ГП ПрименятьСмещениеДоступностиПрослеживаемыхМаркируемыхТоваров
			and ПрослеживаемыеТНВЭД._Fld27184RRef = T1.ТНВЭДСсылка 
			and (ПрослеживаемыеТНВЭД._Fld27185 = 0x01 or ПрослеживаемыеТНВЭД._Fld28120 = 0x01)
			and T1.БлижайшаяДата BETWEEN ПрослеживаемыеТНВЭД._Period AND DateAdd(DAY, 100, ПрослеживаемыеТНВЭД._Period)
OPTION (KEEP PLAN, KEEPFIXED PLAN);
