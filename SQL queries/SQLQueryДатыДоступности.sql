...
Where
	Ќоменклатура._Fld3480 IN (@P_Article1,@P_Article2,@P_Article3,@P_Article4,@P_Article5,@P_Article6,@P_Article7,@P_Article8)
union
Select 
	Ќоменклатура._IDRRef
From 
	dbo._Reference149 Ќоменклатура With (NOLOCK)
Where
	Ќоменклатура._Code IN (@P_Code1,@P_Code2,@P_Code3,@P_Code4,@P_Code5,@P_Code6,@P_Code7,@P_Code8)
OPTION (KEEP PLAN, KEEPFIXED PLAN)
;
...
From 
	dbo._Reference149 Ќоменклатура With (NOLOCK)
	inner join #Temp_GoodsBegin on Ќоменклатура._IDRRef = #Temp_GoodsBegin._IDRRef
