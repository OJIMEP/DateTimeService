...
COMMIT
BEGIN TRANSACTION
ALTER TABLE [dbo].[_InfoRg27183] ADD  CONSTRAINT [PK__InfoRg27183] PRIMARY KEY NONCLUSTERED 
(
	[_Period] ASC,
	[_Fld27184RRef] ASC
) WITH( STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
COMMIT
BEGIN TRANSACTION
ALTER TABLE [dbo].[_InfoRg28348] ADD  CONSTRAINT [PK__InfoRg28348] PRIMARY KEY NONCLUSTERED 
(
	[_Period] ASC,
	[_Fld28349RRef] ASC
)WITH ( STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
