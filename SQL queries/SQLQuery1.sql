...
FROM
    dbo._InfoRg23830 T1 With (NOLOCK)
	Inner Join #Temp_Warehouses ON T1._Fld23833RRef = #Temp_Warehouses.СкладСсылка 
	Inner Join #Temp_Remains ON T1._Fld23831RRef = #Temp_Remains.СкладИсточника AND T1._Fld23832 BETWEEN @P_DateTimeNow AND DateAdd(DAY,6,@P_DateTimeNow)
--WHERE
